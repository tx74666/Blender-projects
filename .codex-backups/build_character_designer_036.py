...
archive = root / 'dist' / 'character_designer-0.36.0.zip'
...
(root / '.codex-backups' / 'forearm-twist-probe' / 'release-0.36.0.json').write_text(json.dumps(report, indent=2), encoding='utf-8')
